...
const numbersAvg = sumNumbers(numbers);
...
function sum() {
  ...
  for (let i = 0; i < mixedArr.length; i++) {
    if (typeof mixedArr[i] === "number" || typeof mixedArr[i] === "boolean") {
      ...
      throw new Error("Unsupported data type, dear user");
    }
  }
  return sumNumbers;
}
...
const numbersAvg2 = [2, 6, 9, 10, 7, 4, 1, 9];
...
function averageNumbers(arrayOfNumbers) {
  ...
  return sumNumbers / arrayOfNumbers.length;
}
